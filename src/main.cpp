    ...
    if (s != "") {
      ...
      if (event == "telemetry") {
        ...
        for (int i = 0; i < sensor_fusion.size(); i++) {
          Obstacle obj = Obstacle(sensor_fusion[i][0],sensor_fusion[i][1],sensor_fusion[i][2],sensor_fusion[i][3],sensor_fusion[i][4],sensor_fusion[i][5],sensor_fusion[i][6]);
        ...
        for (vector<double> next_vals : trajectory) {
          ...
          next_y_vals.push_back(next_vals[1]);
        }
